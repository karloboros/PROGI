...
tečaj
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Administrator odabire ples kojem želi izmijeniti određene podatke
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Klub odabire prijavu od određenog klijenta
							\item Klub odbija određenog klijenta
							\item Prijava se označava kao obrađena
						\end{packed_enum}
						\end{packed_item}
					\end{packed_item}
