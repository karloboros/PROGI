...
odustaje od registracije
					...
					\noindent \underbar{\textbf{UC3 - Registracija kluba}}
					\begin{packed_item}
...
podatke
					...
					\noindent \underbar{\textbf{UC11 - Pregled klubova}}
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Administrator odabire opciju pregledavanja klubova 
							\item Prikaže se lista svih ispravno registriranih korisnika s osobnim podatcima
					...
					\noindent \underbar{\textbf{UC12 - Uređivanje korisničkih računa}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC14 -Pregled osobnih podataka}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC15 -Promjena osobnih podataka}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC16 -Brisanje korisničkog računa}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC17 -Pregled tečajeva na karti slobodnih za upis}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC18 -Odabit tečaja s karte}}
					\begin{packed_item}
...
$>$
					...
					\noindent \underbar{\textbf{UC31 - Pregled aktivnih prijava na tečaj kluba }}
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Prikazuje se stranica koja sadrži informacije o treneru, skupu treninga kroz neko vrijeme, maksimalnom broju sudionika, opis s dodatnim informacijama o težini treninga, uvjetima treniranja i pravilima ponašanja
						\end{packed_enum}
						
						\end{packed_item}
					\end{packed_item}

					\noindent \underbar{\textbf{UC32 -Prijava na tečaj kluba }}
					\begin{packed_item}
