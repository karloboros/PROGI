\chapter*{Dodatak: Prikaz aktivnosti grupe}
		...
		\begin{packed_enum}
			...
			\item  sastanak
			\item[] \begin{packed_item}
				\item Datum: u ovom formatu: 16.12.2022.
				\item Prisustvovali: Mateja Golec, Nina Đurić, Lara Đaković, Lucija Domić, Ana Vrabec, Karlo Boroš
				\item Teme sastanka:
				\begin{packed_item}
				    \item  analiza use case-ova
					\item  podjela u parove za izradu controllera
                        \item  dogovor oko sljedećeg checkpoint-a
				\end{packed_item}
			\end{packed_item}
		\end{packed_enum}
		...
		\section*{Tablica aktivnosti}
			...
			\begin{longtblr}[
				...
				Popis literature 			&  &  &  &  &  &  &  \\  
				&  &  &  &  &  &  &  \\ \hline 
				\textit{Postavljanje klijentske strane aplikacije} 				&  & 9h & 20h &  & 5h & 2h &  \\  
				\textit{Postavljanje serverske strane aplikacije} 				&  & 3h &  20h &  & 4h & 2h &  \\  
